...
import HtmlBeautifier from '@/components/html-beautifier';
...
export const metadata: Metadata = {
  ...
  description: 'Clean up, format, and beautify your HTML code online. Our tool makes your markup readable with proper indentation and syntax highlighting.',
  openGraph: {
    title: 'HTML Beautifier & Formatter | Leo Creator',
    description: 'Paste your HTML code to format and color-code it for better readability.',
  },
  twitter: {
    title: 'HTML Beautifier & Formatter | Leo Creator',
    description: 'Paste your HTML code to format and color-code it for better readability.',
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <p className="mt-3 text-lg text-muted-foreground md:text-xl">
              Paste your HTML code to format and color-code it for better readability.
            </p>
          </div>
          <TopAdBanner />
          <HtmlBeautifier />
