...
export const metadata: Metadata = {
  title: 'Universal HTML Converter',
  description: 'Convert Word, Excel, PDF documents, or live URLs into a single, self-contained HTML file with assets. Preserve formatting, images, and styles.',
  openGraph: {
    title: 'Universal HTML Converter | Leo Creator',
    description: 'Convert Word, Excel, PDF, or URLs to a self-contained HTML package.',
  },
  twitter: {
    title: 'Universal HTML Converter | Leo Creator',
    description: 'Convert Word, Excel, PDF, or URLs to a self-contained HTML package.',
        ...
        <div className="mx-auto max-w-4xl">
          <div className="text-center">
            <h1 className="font-headline text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
              Universal HTML Converter
            </h1>
            <p className="mt-3 text-lg text-muted-foreground md:text-xl">
              Convert Word, Excel, PDF, or a URL into a downloadable HTML package.
            </p>
          </div>
          <TopAdBanner />
          <HtmlConverter />
