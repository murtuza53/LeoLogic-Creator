...
export const metadata: Metadata = {
  ...
  description: 'Generate high-quality, SEO-friendly blog posts in seconds. Just provide a topic or an outline, and let our AI do the writing for you.',
  openGraph: {
    title: 'AI Blog Post Writer | Leo Creator',
    description: 'Instantly generate complete blog articles from a topic or outline.',
  },
  twitter: {
        ...
        <div className="mx-auto max-w-4xl">
          <div className="text-center">
            ...
            <p className="mt-3 text-lg text-muted-foreground md:text-xl">
              Generate a complete, SEO-friendly blog post from a topic or outline in seconds.
            </p>
          </div>
          <TopAdBanner />
          <AIBlogWriter />
